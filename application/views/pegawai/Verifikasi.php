...
<div class="main-card card mb-3">
    <div class="card-body border border-warning">
        <h5 class="card-title">Verifikasi Pegawai</h5>
            ...
            <div>
                <div class="form-group col-4 d-inline-block align-middle">
                    <div class="position-relative form-group">
                        <input name="username" id="" type="text" class="form-control" placeholder="NIP" required>
                        <!-- <button type="submit" class="btn btn-primary align- right" name="submit" value="Submit">Submit</button> -->
                    </div>
                    <div class="position-relative form-group">
                        <input name="password" id="" type="text" class="form-control" placeholder="NAMA PNS" required>
                    </div>
                    <div class="position-relative form-group">
                        <input name="pns_id" id="" type="text" class="form-control" placeholder="NO TELEPHONE" required>
                    </div>
                </div>
                <div class="form-group col-2 d-block align-middle">
                    <button type="submit" class="btn btn-primary align-middle" name="submit" value="Submit">Proses</button>
                </div>
